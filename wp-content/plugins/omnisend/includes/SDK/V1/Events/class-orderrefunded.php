...
/**
 * Omnisend OrderRefunded class. It should be used with Omnisend Event.
 */
class OrderRefunded extends OrderBase {
	public const EVENT_NAME = 'order refunded';
	...
	/**
	 * Sets order refunded tax amount
	 *
	 * @param mixed $total_refunded_tax_amount
	 *
	 * @return void
	 */
	public function set_total_refunded_tax_amount( $total_refunded_tax_amount ): void {
		$this->total_refunded_tax_amount = $total_refunded_tax_amount;
	}

	/**
	 * Sets order refunded amount
	 *
	 * @param mixed $total_refunded_amount
	 *
	 * @return void
	 */
	public function set_total_refunded_amount( $total_refunded_amount ): void {
	...
	/**
	 * Adds order LineItem component of refunded item
	 *
	 * @param LineItem $refunded_line_item
	 *
	 * @return void
	 */
	public function add_refunded_line_item( $refunded_line_item ): void {
		$this->refunded_line_items[] = $refunded_line_item;
	}
	 ...
	 * @return WP_Error
	 */
	public function validate_extra_properties( WP_Error $error ): WP_Error {
		foreach ( $this->refunded_line_items as $item ) {
			if ( ! $item instanceof LineItem ) {
				$error->add( 'refunded_line_item', 'Refunded line item is not an instance of LineItem' );
			}
		}
