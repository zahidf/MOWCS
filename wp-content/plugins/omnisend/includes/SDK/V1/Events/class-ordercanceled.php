...
/**
 * Omnisend OrderCanceled class. It should be used with Omnisend Event.
 */
class OrderCanceled extends OrderBase {
	...
	/**
	 * Sets order cancel reason
	 *
	 * @param string $cancel_reason
	 *
	 * @return void
	 */
	public function set_cancel_reason( $cancel_reason ): void {
